...
public class TheWalls2LocationData{
	...
	private Cuboid worldCube=new Cuboid(new Location(null,-917,5,-245),new Location(null,-671,112,-47));
	...
	public TheWalls2LocationData(World world){
		...
		walls.add(new Cuboid(new Location(null,-864,68,-164),new Location(null,-803,97,-164)));
